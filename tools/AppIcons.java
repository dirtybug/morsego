...
public class AppIcons {
    ...
    public static final int TAB_KEYER = 3;
    public static final int TAB_USB = 4;
    public static final int ICON_SETTINGS = 5;
    ...
    public static final String PATH_RADIO = "M3.24,6.15C2.51,6.6 2,7.41 2,8.35v11.3C2,21.01 2.99,22 4.21,22h15.58c1.22,0 2.21,-0.99 2.21,-2.35V8.35c0,-0.94 -0.51,-1.75 -1.24,-2.2L12.56,2.27c-0.34,-0.2 -0.77,-0.2 -1.11,0L3.24,6.15z M12,18c-2.21,0 -4,-1.79 -4,-4s1.79,-4 4,-4 4,1.79 4,4 -1.79,4 -4,4z";
    ...
    private static final Path2D SHAPE_RADIO = SvgPathParser.parsePath(PATH_RADIO);
    ...
    public static void drawIcon(Graphics2D g, int index, double cx, double cy, double size, Color color) {
        Path2D src;
        switch (index) {
            case TAB_TREE: src = SHAPE_TREE; break;
            case TAB_SEND: src = SHAPE_FINGER; break;
            case TAB_RECEIVE: src = SHAPE_EAR; break;
            case TAB_KEYER: src = SHAPE_RADIO; break;
            case TAB_USB: src = SHAPE_HARDWARE; break;
            case ICON_SETTINGS: src = SHAPE_SETTINGS; break;
            default: return;
        }
    ...
    public static void drawSettingsIcon(Graphics2D g, double cx, double cy, double size, Color color) {
        drawIcon(g, ICON_SETTINGS, cx, cy, size, color);
    }
}
