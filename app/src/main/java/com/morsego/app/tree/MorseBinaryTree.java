...
public class MorseBinaryTree {
    ...
    private void buildLevels() {
        ...
        // Level 18: Numbers 9 & 0
        TreeLevel l18 = new TreeLevel(18, "9", "----.", "0", "-----", pool,
                "Nível 18: Números (9 e 0)",
        ...
        // Level 21: Prosigns SOS and AR
        TreeLevel l21 = new TreeLevel(21, "SOS", "...---...", "AR", ".-.-.", pool,
                "Nível 21: Sinais Especiais (SOS e AR)",
                "Chamada de socorro SOS (...---...) e fim de mensagem AR (.-.-.).");
        levels.add(l21);
    }
